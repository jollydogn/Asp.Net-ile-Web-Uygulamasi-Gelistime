<%@ Page Title="" Language="C#" MasterPageFile="~/Yönetim Paneli/Yetkili Giriş Paneli/YetkiliGirisMaster.master" AutoEventWireup="true" CodeFile="kullaniciEkle.aspx.cs" Inherits="kullaniciEkle" %>
                        ...
                        <div class="form-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ControlToValidate="txtAd" ErrorMessage="Sadece harf giriniz." ValidationExpression="[a-zA-Z]+" ForeColor="Red"></asp:RegularExpressionValidator>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" ControlToValidate="txtKullaniciAd" ErrorMessage="Sadece harf giriniz." ValidationExpression="[a-zA-Z]+" ForeColor="Red"></asp:RegularExpressionValidator>
