						...
						<div class="widget-shadow " data-example-id="basic-forms"> 
							...
							<div class="form-body">
                             ...
                             <div class="col-sm-9" style="float:left;width:500px">
                                 ...
                                 <asp:Button  class="btn btn-default" Text="Onayla" runat="server"  style="background-color:#F2B33F;color:#fff" ID="btnKatOnayla" Height="35px" OnClick="btnKatOnayla_Click"/>
							 </div> 
                                     </div>
                                 <div class="form-group">
                             <asp:Label runat="server" for="inputEmail3" class="col-sm-2 control-label">İşlem Yapılan Kat</asp:Label>
                             <div class="col-sm-9">
                                   <asp:DropDownList class="form-control" runat="server" ID="drpKatSayisi" AutoPostBack="True" OnSelectedIndexChanged="drpKatSayisi_SelectedIndexChanged"  ></asp:DropDownList>
                             </div>
							 </div> 
                                  <div class="form-group">
                             ...
                             <div class="col-sm-9" style="float:left;width:500px">
                                 ...
                                 <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Lütfen bu alanı boş bırakmayınız." ControlToValidate="txtOdaSayisi" ForeColor="Red"></asp:RequiredFieldValidator>
                                        ...
                                        <div class="col-sm-offset-2"> 
                                 <asp:Button  class="btn btn-default" Text="Onayla" runat="server"  style="background-color:#F2B33F;color:#fff" ID="btnOdaOnayla" Height="35px" OnClick="btnOdaOnayla_Click"/>
							 </div> 
                                     </div>
                                 <div class="form-group" >
                             ...
                             <div class="col-sm-offset-2"> 
                             <asp:Button  class="btn btn-default" Text="Oda Ekle" runat="server"  style="background-color:#F2B33F;color:#fff" ID="btnKullaniciEkle" OnClick="btnKullaniciEkle_Click"/>&nbsp&nbsp<asp:Label runat="server" ID="lblOnay" Visible="False" ForeColor="#32C867"></asp:Label>
                             </div>
