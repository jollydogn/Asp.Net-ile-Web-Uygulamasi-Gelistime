<%@ Page Title="" Language="C#" MasterPageFile="~/Yönetim Paneli/Yetkili Giriş Paneli/YetkiliGirisMaster.master" AutoEventWireup="true" CodeFile="odaTipDuzenle.aspx.cs" Inherits="odaTipDuzenleme" %>
                ...
                <div class=" form-grids row form-grids-right">
                    <div class="widget-shadow " data-example-id="basic-forms">
                        <div class="form-title">
                            <h4>Oda Tip Düzenle :</h4>
                        </div>

                        <div class="form-body">
                            <div class="form-group">
                                <asp:Label runat="server" for="inputEmail3" class="col-sm-2 control-label">Düzenlenecek Tip</asp:Label>
                                <div class="col-sm-9">
                                    <asp:DropDownList class="form-control" runat="server" ID="drpTip" AutoPostBack="True" OnSelectedIndexChanged="drpTip_SelectedIndexChanged"></asp:DropDownList>
                                </div>
                            </div>
                            <div class="form-group">
                                <asp:Label runat="server" for="inputEmail3" class="col-sm-2 control-label">Fotoğraf</asp:Label>
                                <div class="col-sm-9">
                                    <asp:Image runat="server" ID="odaTipFotograf" Width="100" Height="100" /><br />
                                    <br />
                                    <asp:FileUpload runat="server" ID="fuFotograf" />
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ErrorMessage="Lütfen bu alanı boş bırakmayınız." ControlToValidate="fuFotograf" ForeColor="Red"></asp:RequiredFieldValidator>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" ControlToValidate="txtTipAd" ErrorMessage="Sadece harf giriniz." ValidationExpression="[a-zA-Z]+" ForeColor="Red"></asp:RegularExpressionValidator>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <asp:TextBox runat="server" ID="txtTipAciklama" class="form-control" placeholder="Tip Açıklama"></asp:TextBox>
                                    ...
                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="txtTipAciklama" ErrorMessage="Sadece harf giriniz." ValidationExpression="[a-zA-Z]+" ForeColor="Red"></asp:RegularExpressionValidator>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <asp:TextBox runat="server" ID="txtKapasite" class="form-control" placeholder="Tip Kapasite"></asp:TextBox>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <asp:TextBox runat="server" ID="txtFiyat" class="form-control" placeholder="Tip Fiyat"></asp:TextBox>
                            ...
                            <div class="col-sm-offset-2">
                                <asp:Button class="btn btn-default" Text="Güncelle" runat="server" Style="background-color: #F2B33F; color: #fff" ID="btnTipDuzenle" OnClick="btnTipDuzenle_Click" />&nbsp&nbsp<asp:Label runat="server" ID="lblOnay" Visible="False" ForeColor="#32C867"></asp:Label>
                            </div>
                        </div>
                    </div>
                </div>
